...
Revision ID: 2a73428db0e3
Revises: 
Create Date: 2026-04-04 04:12:39.158188
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_dishes_dining_hall_id_elo_rating'),
        'dishes',
        ['dining_hall_id', 'elo_rating'],
        unique=False,
   )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_dishes_elo_rating'), table_name='dishes')
