...
export const LeaderboardRow = memo(function LeaderboardRow({
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-[2.75rem_minmax(0,1.5fr)_minmax(0,1.1fr)_auto] items-center gap-3 border-t border-zinc-100 px-5 py-4 text-sm text-zinc-700 will-change-transform first:border-t-0 sm:grid-cols-[3rem_minmax(0,1.5fr)_minmax(0,1.15fr)_auto] sm:gap-4"
    >
      <span className="tabular-nums text-zinc-500">{rank}.</span>
